...
!!    arrays which contain data related to reservoirs
      ...
      !!!!! added by ADAPT for reservoir routing
      allocate (adapt_res_eh(mres))
      allocate (adapt_res_ph(mres))
      allocate (adapt_b0(mres))
      allocate (adapt_b1(mres))
      allocate (adapt_alpha(mres))
      allocate (adapt_h0(mres))
      allocate (adapt_beta(mres))
      allocate (adapt_k(mres))

      allocate (adapt_hv(mres,999,2))
      allocate (adapt_md(mres,999,2))
      allocate (adapt_ha(mres,999,2))

      allocate (adapt_outflow(mres))
      !!!!!
